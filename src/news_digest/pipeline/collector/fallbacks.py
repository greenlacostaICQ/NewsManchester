...
def _weather_draft_line(
    ...
    if (
        ...
        if heat_severity == "high":
            ...
            practical = "Дождь может идти долго; зонт или капюшон лучше взять сразу."
        elif rain_probability >= 70:
            practical = "Уличные планы лучше держать гибкими; зонт или капюшон пригодятся."
        elif rain_probability >= 50:
            practical = "Для прогулок и пересадок лучше взять зонт или капюшон."
        elif rain_probability >= 30:
            practical = "Если надолго выходите на улицу, лёгкий зонт лучше взять с собой."
        else:
