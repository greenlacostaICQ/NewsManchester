...
CATEGORY_AUTHORITY: dict[str, tuple[str, ...]] = {
    ...
    "culture_weekly": (
        ...
        "The Manc",
        "Secret Manchester Monthly Guide",
...
SOURCE_TIER: dict[str, int] = {
    ...
    "Fairfield Social Club": 1,
    "Planetarium Go Manchester": 1,
    "PHM Makers Market": 1,
    "Manchester Brick Festival": 1,
    "Foodies Festival Tatton Park": 1,
    "Festwich": 1,
    "Campfield Market": 1,
    "Didsbury Arts Festival": 1,
    ...
    "Heritage Live": 2,
    "VisitSalford Events": 2,
    "SK Lowdown Markets": 2,
    "CompiledMCR Tech Events": 2,
    "BusinessLive Greater Manchester": 2,
    ...
    "Secret Manchester Monthly Guide": 3,
    ...
    "The Manc Eats": 3,
    "Confidentials": 3,
    "Skiddle Manchester Festivals": 3,
    "Skiddle Manchester Comedy": 3,
    "First Street Makers Market": 3,
    "Great Northern Makers Market": 3,
    "Levenshulme Artisan Market": 3,
    "Northern Quarter Makers Market": 3,
    "Prestwich Makers Market": 3,
    "Stockport Makers Market": 3,
    "Urmston Artisan Market": 3,
    "Chorlton Makers Market": 3,
    "Afisha London": 3,
    "MTicket Russian Concerts": 3,
    ...
    "Barton Aerodrome Car Boot": 4,
    "Bowlee Car Boot Sale": 4,
    "New Smithfield Sunday Market": 4,
    "Burnage RFC Car Boot Sale": 4,
    "The BIG Stockport Car Boot": 4,
    "Bolton Car Boot Sale": 4,
}
