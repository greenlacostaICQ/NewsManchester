...
- `fetch_cache.json` — per-URL ETag / Last-Modified validators used by
  ...
  are ignored. Lives in `fetch.py` (`load_fetch_cache` / `save_fetch_cache`).
