...
- Статус: внедрено; night-wave и первый production dry-run выявили остаточный MediaCity date-card gap, parser исправлен; финальный production-proof ожидается на актуальном commit.
