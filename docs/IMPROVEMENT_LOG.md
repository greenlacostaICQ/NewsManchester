...
- Статус: внедрено; offline/replay проверка пройдена, production-proof ожидается от ближайшей night events-wave и утреннего выпуска.
...
- ПРОВЕРКА (offline/replay): source probes: MediaCity `13`, Ai Weiwei `1`, Totally Stockport `30`, Levenshulme Pride `1` candidates; Mottram/Sale/Bolton pages fetched cleanly и дали `0` после current-date gate 20 августа, как ожидается для прошедшего 16 августа. Replay 16.08 до: plan `45`, writer/verify `44 shown`, `1 removed`, `43` bullets, Weekend `9`; после: plan `46`, writer/verify `45 shown`, `1 removed`, `44` bullets, Weekend `10`, B-Boy visible, composition `special=4 / exhibitions=1 / routine=5`, новых plan mismatch нет. Golden replay `12/12`: plan/write/verify counts совпали с baseline на каждом дне. После исправления трёх CI-контрактов полный набор `1050/1050`; повторный replay 16.08 сохранил `45 shown / 1 removed / 44 bullets`.
